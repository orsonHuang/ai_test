...
- todolist 提到 D 盘工作日记被密码保护（8位数字，重要的日子）。
- 入职资料中有入职日期：2024年3月6日 → 密码是 20240306。
- 输入"20240306"后，D盘工作日记解锁，进入第2章。
- 入职资料里有系统密码 ZY2024!starlight，用它打开私人文件夹。
- 账号密码.txt 里有 VPN 密码 StarCore@2024，用它连接公司服务器获取录音。
- 最终密码 origin0306 打开未命名文档。
